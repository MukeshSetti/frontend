...
export const popularDishes = [
  ...
  export const tables = [
    ...
    { id: 11, name: "Table 1", status: "Booked", initial: "AM", seats: 4 },
    { id: 12, name: "Table 2", status: "Available", initial: "MB", seats: 6 },
    { id: 13, name: "Table 3", status: "Booked", initial: "JS", seats: 2 },
    { id: 14, name: "Table 4", status: "Available", initial: "HR", seats: 4 },
    { id: 15, name: "Table 5", status: "Booked", initial: "PL", seats: 3 },
    { id: 16, name: "Table 6", status: "Available", initial: "RT", seats: 4 },
    { id: 17, name: "Table 7", status: "Booked", initial: "LC", seats: 5 },
    { id: 18, name: "Table 8", status: "Available", initial: "DP", seats: 5 },
    { id: 19, name: "Table 9", status: "Booked", initial: "NK", seats: 6 },
    { id: 20, name: "Table 10", status: "Available", initial: "SB", seats: 6 },
